...
const useStyles = createUseStyles({
  ...
  background: {
    visibility: "visible",
    boxSizing: "border-box",
    background: 'url("1.jpg") 0% 0% / cover',
    height: "inherit",
  },
  appMockupImage: {
          ...
          <ClearFix style={{ height: "100%", backgroundColor: "transparent" }}>
            {isHidden ? null : (
              <img
                src="iphone.png"
                alt="mockup image"
                className={classes.appMockupImage}
              ></img>
            )}
              ...
              >
                <div className={classes.emphasisTitle}>
                  <h1 {...(isHidden ? { style: { fontSize: 40 } } : {})}>
                    The new way to listen to your favorite radio, music and
                    podcast. Try using <strong>SVARA</strong> Apps.
                  </h1>
                </div>
              </div>
            </div>
