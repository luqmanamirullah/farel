        ...
        <Row>
          <Col xl={5}>
            <HeadingBlock withBorder>
              <h1 style={{ textAlign: "left" }}>SVARA ONLINE</h1>
              <span></span>
            </HeadingBlock>
            <p className={classes.lead}>
              Sebuah platform berupa Mobile Apps (Android, IoS), Website, dan
              IoT (Smart Speaker, Connected Car, Smart TV, etc) untuk user dalam
              menikmati berbagai jenis layanan konten radio live streaming,
              podcast, &amp; music and Video. beberapa fitur utama yaitu audio
              and video live streaming, live chat, social, user generate
              content, take offline, dan berbagai layanan membership.
            </p>
          </Col>
          <Col xl={7}>
            <div
...
const AnotherDevice = () => {
  ...
  return (
    <ContentWrap>
      <div style={{ textAlign: "center" }}>
        <h2>Listening to SVARA Using a Device other than a Smartphone?</h2>
      </div>
      <ClearFix>
        <Row>
...
const SvaraDevice = ({ image, name, description }) => {
  ...
  return (
    <div className={classes.imageWrapper}>
      ...
      />
      <h4 style={{ marginBottom: 30, textAlign: "center" }}>{name}</h4>
      <p style={{ lineHeight: 1.8, textAlign: "center" }}>{description}</p>
    </div>
  );
};
