...
const BlogCard = ({ imageSrc, imageUrl, alt, href, title, date, description }) => {
	...
	return (
		<div style={{ display: 'flex', flexDirection: 'column' }}>
			...
			<div className={classes.description}>
				...
				<a href={href} className={classes.moreLink} target="_blank" rel="noreferrer">
					Read More
				</a>
			</div>
		</div>
